...
export const InputField = ({open, filterContacts}) => {
  return (
    <div className='flex gap-2'>
       <div className='flex relative items-center grow'>
        <IoSearchOutline className='text-white text-3xl absolute ml-2' />
        <input type="text" className='bg-transparent border border-white rounded-md h-10 grow text-white pl-9' onChange={filterContacts} />
      </div>
      <div>
